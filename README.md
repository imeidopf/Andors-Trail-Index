...
I am building this for two reasons: 1) to build something in python, and 2) to provide other players with an updated version of the current directory listed on the [Andor's Trail Website](https://andorstrail.com/) [found here](http://andorstrail.irkalla.cz/0.7.0/).
